...
<div class="element-section info-block">
  ...
  <table class="applications-table">
    ...
    <tbody>
      <tr>
        <td>HSLA &amp; stainless steel</td>
        <td>Mo alloying for strength, hardenability, corrosion resistance</td>
        <td>~80% of Mo demand. Critical for pipeline steels (X70/X80), pressure vessels, 316L stainless</td>
      </tr>
      <tr>
        <td>Superalloys</td>
        <td>Mo in Ni- and Co-based superalloys (Hastelloy, Inconel)</td>
        <td>Jet-engine combustion sections, gas turbines, chemical reactors</td>
      </tr>
      <tr>
        <td>Catalysts</td>
      ...
      <tr>
        <td>Mo metal &amp; wire</td>
        <td>Mo electrodes, sputtering targets, furnace heating elements</td>
        <td>Glass-melting electrodes, semiconductor metallisation, vacuum furnace components</td>
      </tr>
      <tr>
        <td>Lubricants</td>
        <td>MoS<sub>2</sub> solid lubricant additive</td>
        <td>High-pressure lubricant for gears, bearings, fasteners</td>
      </tr>
    </tbody>
  </table>
</div>
  ...
  <div class="market-stats-grid">
    <div class="market-stats">
      <div class="stat-row">
        ...
        <span class="stat-value">~250,000&thinsp;t Mo/year [4]</span>
      </div>
      <div class="stat-row">
        <span class="stat-label">China share</span>
        <span class="stat-value">~40%</span>
      </div>
      <div class="stat-row">
        <span class="stat-label">Other top producers</span>
        <span class="stat-value">Chile, Peru, USA, Mexico</span>
      </div>
      <div class="stat-row">
        <span class="stat-label">Co-product source</span>
        <span class="stat-value">~60% as Cu by-product</span>
      </div>
    </div>
    <div class="market-stats">
      <div class="stat-row">
...
<div class="element-section info-block">
  ...
  <p class="section-intro">Molybdenum trades on a thick global market with Platts MoO<sub>3</sub> as the headline benchmark. Retail metal listings are gram- to kilogram-scale rod, plate, and powder. The auto-rendered table shows tracked listings.</p>
...
<div class="element-section info-block">
  ...
  <div class="notes-block">
    <div class="note-item note-warning">
      <strong>Licence regime active</strong>
      MOFCOM No.&thinsp;10/2025 [2] requires Chinese export licences for Mo metal, ferromolybdenum, MoO<sub>3</sub> and ammonium molybdate. Compliance load is now permanent for Chinese exporters.
    </div>
    <div class="note-item">
...
<div class="compact-properties">
  <div class="compact-prop-title">Physical Properties <a href="https://www.wolframalpha.com/input?i=molybdenum+element" target="_blank" rel="noopener">[1]</a></div>
  Z: 42 &middot; A<sub>r</sub>: 95.95&thinsp;u &middot; &rho;: 10.28&thinsp;g/cm<sup>3</sup> &middot; T<sub>m</sub>: 2,623&thinsp;&deg;C &middot; T<sub>b</sub>: 4,639&thinsp;&deg;C<br>
  Crystal: bcc &middot; Config: [Kr]4d<sup>5</sup>5s<sup>1</sup> &middot; Ox. states: -2 to +6
</div>
