  ...
  <table class="applications-table">
    ...
    <tbody>
      <tr>
        ...
        <td>Bismuth subsalicylate (Pepto-Bismol), bismuth subcitrate</td>
        <td>~30% of Bi demand. OTC anti-diarrhoeal and H. pylori treatment. Produced at scale by Procter &amp; Gamble and Takeda.</td>
      </tr>
      <tr>
      ...
      <tr>
        <td>Pigments &amp; cosmetics</td>
        <td>Bismuth oxychloride pearlescent pigment</td>
        <td>Cosmetic shimmer effect in eye shadow, nail polish, lipstick</td>
      </tr>
      <tr>
        <td>Free-machining steels</td>
        <td>Bi addition replacing lead in cutting steels</td>
        <td>RoHS/REACH-compliant Pb-free machining steel for automotive parts</td>
      </tr>
      <tr>
        <td>Catalysts</td>
  ...
  <div class="market-stats-grid">
    <div class="market-stats">
      <div class="stat-row">
        ...
        <span class="stat-value">~17,000&thinsp;t/year [4]</span>
      </div>
      <div class="stat-row">
      ...
      <div class="stat-row">
        ...
        <span class="stat-value">Pb/Cu smelter by-product</span>
      </div>
      <div class="stat-row">
        <span class="stat-label">Other producers</span>
        <span class="stat-value">Laos, South Korea, Japan, Mexico</span>
      </div>
    </div>
    <div class="market-stats">
      <div class="stat-row">
...
<div class="element-section info-block">
  ...
  <div class="notes-block">
    <div class="note-item note-warning">
      ...
      MOFCOM No.&thinsp;10/2025 [2] requires Chinese export licences for Bi metal, Bi<sub>2</sub>O<sub>3</sub>, and bismuth pharmaceuticals. Pharmaceutical APIs are subject to additional dual-classification scrutiny.
    </div>
    <div class="note-item">
      <strong>Co-product constraint</strong>
      Bismuth is recovered from lead and copper smelter dross. Production cannot scale independently of base-metal smelting throughput; new Bi capacity requires modifying anode-slime treatment circuits at integrated smelters.
    </div>
    <div class="note-item">
...
<div class="compact-properties">
  <div class="compact-prop-title">Physical Properties <a href="https://www.wolframalpha.com/input?i=bismuth+element" target="_blank" rel="noopener">[1]</a></div>
  Z: 83 &middot; A<sub>r</sub>: 208.980&thinsp;u &middot; &rho;: 9.78&thinsp;g/cm<sup>3</sup> &middot; T<sub>m</sub>: 271.4&thinsp;&deg;C &middot; T<sub>b</sub>: 1,564&thinsp;&deg;C<br>
  Crystal: rhombohedral &middot; Config: [Xe]4f<sup>14</sup>5d<sup>10</sup>6s<sup>2</sup>6p<sup>3</sup> &middot; Ox. states: -3, +3, +5
</div>
