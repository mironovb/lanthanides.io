...
<div class="element-section info-block">
  ...
  <table class="applications-table">
    ...
    <tbody>
      <tr>
        <td>MRI contrast agents</td>
        <td>Gd(III) chelates: gadopentetate, gadobutrol, gadoteridol</td>
        <td>~30% of MRI exams worldwide use Gd-based contrast; FDA-approved agents include Magnevist, Gadavist, ProHance. Critical clinical workflow with no economic substitute.</td>
      </tr>
      <tr>
        <td>NdFeB magnet additive</td>
        <td>Trace Gd substitution for Nd</td>
        <td>Improves temperature stability and corrosion resistance of permanent magnets at lower cost than Dy/Tb</td>
      </tr>
      <tr>
        <td>Neutron shielding</td>
        <td>Gd<sub>2</sub>O<sub>3</sub> in nuclear reactor control rods and fuel</td>
        <td>Highest thermal-neutron capture cross-section of any element (~49,000&thinsp;barns); used as burnable poison</td>
      </tr>
      <tr>
      ...
      <tr>
        <td>Phosphors</td>
        <td>Gd<sub>2</sub>O<sub>2</sub>S:Tb (X-ray screens), GOS scintillators</td>
        <td>Medical X-ray imaging intensifying screens; CT detector ceramics</td>
      </tr>
    </tbody>
  </table>
</div>
...
<div class="element-section info-block">
  ...
  <div class="market-stats-grid">
    <div class="market-stats">
      <div class="stat-row">
        <span class="stat-label">Global Gd<sub>2</sub>O<sub>3</sub> production</span>
        <span class="stat-value">~2,400&thinsp;t/year (REO basis)</span>
      </div>
      <div class="stat-row">
      ...
      <div class="stat-row">
        <span class="stat-label">MRI contrast agent share</span>
        <span class="stat-value">~30% of demand</span>
      </div>
      <div class="stat-row">
        <span class="stat-label">Magnet additive share</span>
        <span class="stat-value">~40% of demand</span>
      </div>
    </div>
    <div class="market-stats">
      <div class="stat-row">
...
<div class="compact-properties">
  <div class="compact-prop-title">Physical Properties <a href="https://www.wolframalpha.com/input?i=gadolinium+element" target="_blank" rel="noopener">[1]</a></div>
  Z: 64 &middot; A<sub>r</sub>: 157.25&thinsp;u &middot; &rho;: 7.90&thinsp;g/cm<sup>3</sup> &middot; T<sub>m</sub>: 1,313&thinsp;&deg;C &middot; T<sub>b</sub>: 3,273&thinsp;&deg;C<br>
  Crystal: hcp &middot; Config: [Xe]4f<sup>7</sup>5d<sup>1</sup>6s<sup>2</sup> &middot; Ox. states: +3
</div>
