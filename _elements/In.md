...
<div class="element-section info-block">
  ...
  <table class="applications-table">
    ...
    <tbody>
      <tr>
        <td>ITO transparent conductors</td>
        <td>Indium tin oxide sputter targets for displays and touchscreens</td>
        <td>~70% of In demand. Coating on every smartphone, tablet, monitor, and TV. Substitution by silver nanowire/PEDOT:PSS slow.</td>
      </tr>
      <tr>
        <td>CIGS thin-film solar</td>
        <td>Cu(In,Ga)Se<sub>2</sub> photovoltaic absorber</td>
        <td>Flexible thin-film solar cells; smaller volume than crystalline-Si but indium-intensive per watt</td>
      </tr>
      <tr>
  ...
  <div class="market-stats-grid">
    <div class="market-stats">
      <div class="stat-row">
        ...
        <span class="stat-value">~900&thinsp;t/year [4]</span>
      </div>
      <div class="stat-row">
      ...
      <div class="stat-row">
        <span class="stat-label">Other major refiners</span>
        <span class="stat-value">South Korea, Japan, Canada, Belgium</span>
      </div>
      <div class="stat-row">
        <span class="stat-label">Source</span>
        <span class="stat-value">Zn smelter residue (co-product)</span>
      </div>
    </div>
    <div class="market-stats">
      <div class="stat-row">
...
<div class="element-section info-block">
  ...
  <div class="notes-block">
    <div class="note-item note-warning">
      ...
      MOFCOM No.&thinsp;10/2025 [2] requires licences for In metal, ITO sputter targets, and InP/InAs wafers. Display-industry ITO target supply chains qualify multiple sources but the dominant target makers are concentrated in China, South Korea, and Japan.
    </div>
    <div class="note-item">
    ...
    <div class="note-item">
      ...
      ITO is the dominant transparent conductor for LCD and OLED panels. Substitution by silver nanowires (e.g. Cambrios) or PEDOT:PSS exists for flexible/wearable displays but does not match ITO&rsquo;s sheet resistance/transparency tradeoff for mainstream displays.
    </div>
  </div>
</div>

<div class="compact-properties">
  <div class="compact-prop-title">Physical Properties <a href="https://www.wolframalpha.com/input?i=indium+element" target="_blank" rel="noopener">[1]</a></div>
  Z: 49 &middot; A<sub>r</sub>: 114.818&thinsp;u &middot; &rho;: 7.31&thinsp;g/cm<sup>3</sup> &middot; T<sub>m</sub>: 156.6&thinsp;&deg;C &middot; T<sub>b</sub>: 2,072&thinsp;&deg;C<br>
  Crystal: tetragonal &middot; Config: [Kr]4d<sup>10</sup>5s<sup>2</sup>5p<sup>1</sup> &middot; Ox. states: +1, +3
</div>
