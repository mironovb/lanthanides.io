...
This is the operational counterpart to the [regulatory tracker](/regulatory/) and [pricing methodology](/methodology/). Where those pages catalogue the timeline and document how prices are collected, this page is for procurement decisions: how to classify a product into a regulatory tier, what tariff stack applies, what a realistic landed cost looks like, and which channel fits which buyer.
...
| Sm / Gd / Tb / Dy / Lu / Sc / Y oxides, metals, alloys, or HREE-containing NdFeB / SmCo | Tier 3 (case-by-case under MOFCOM Annc 18) | Budget 60 to 120 day lead time; ~50% approval rate |

**Q2: What is the lot size relative to producer MOQ?**

| Lot | Realistic counterparty types |
|---|---|
| Sample / R&D (1 to 10 kg) | Alibaba gold-supplier; Western trader; Grirem R&D desk |
| Sub-container (100 kg to 5 t) | Western trader; mid-tier listed magnet maker; Shenghe trading |
...
| First-time Western buyer with documented use case | 1.3 to 2.0× index |
...
|---|---|---|---|---|
| **1: Uncontrolled** | NdPr / La / Ce oxide; cerium compounds; polishing powder; mischmetal | $300 to $500 | None | 0% |
| **2: General licence** | Sintered NdFeB magnets from JL MAG (broad), Yunsheng (partial), Sanhuan (partial), Jintian (incl. Ford) | $500 to $1,200 | 5 to 10 days for declaration sign-off | 5 to 10% (GL revocation risk) |
| **3: Case-by-case** | Sm/Gd/Tb/Dy/Lu/Sc/Y oxides, metals, alloys, compounds; Dy/Tb-containing NdFeB; SmCo magnets | $3,000 to $10,000 | Statutory 45 working days; actual 60 to 120+ days | EV 25 to 50% of shipment value, or insurance-equivalent 1.0 to 3.0% of value/year |

**Tier 3 nuance:** Arnold Magnetic Technologies notes that *"a classification of 'no rejection' often just means the application is on hold indefinitely."* The 50% approval rate is an EU proxy from Reuters / Šefčovič (October to November 2025); MOFCOM publishes no official statistics.
...
- **IEEPA tariffs ended Feb 24, 2026** (12:00 AM ET) per CBP CSMS #67834313, following SCOTUS *Learning Resources, Inc. v. Trump* (6 to 3, opinion by Roberts) on February 20, 2026. EO 14389 terminated IEEPA-derived duties under nine prior EOs.
...
**IEEPA refund process:** CBP CAPE Phase 1 launched April 20, 2026 (CSMS #68396594); first refunds began ~May 11, 2026. Importers who paid IEEPA duties Feb 2025 to Feb 24, 2026 can file via ACE Portal.

---

## China-side export controls

Verified active regime. See [/regulatory/](/regulatory/) for the full timeline. Operational summary:
...
| MOFCOM Announcements 55 to 58, 61, 62 (2025): extraterritorial + five more REEs (Ho, Er, Tm, Eu, Yb) | **Suspended through November 28, 2026** (by No. 70) |
...
What needs MOFCOM paperwork and what is open right now (May 17, 2026). The status reflects two layers: **Annc 18 of April 2025** (in force, never suspended) and the **Oct 9, 2025 package** (Annc 55 to 58, 61, 62, currently suspended through November 28, 2026 by Annc 70).
...
|---|---|---|---|
| NdFeB magnet, low-temp (N35 to N52, no Dy/Tb) | Nd, Pr, Fe, B | Open under Annc 18; practically routed via Tier 2 GL holders for shipping predictability | Unambiguous (per element scope) |
| NdFeB magnet, mid-temp (N48H, ~1 to 4% Dy) | Nd, Pr, Fe, B, Dy | **Tier 3** (covered under Tier 2 GL if from JL MAG / Yunsheng / Sanhuan / Jintian) | Unambiguous ([Dy](/elements/Dy/) page confirms "finished NdFeB rotors containing Dy") |
| NdFeB magnet, high-temp (N42SH/UH/EH, Dy + Tb) | Nd, Pr, Fe, B, Dy, Tb | **Tier 3** (Tier 2 GL only) | Unambiguous |
| SmCo magnet (Sm₂Co₁₇, SmCo₅) | Sm, Co | **Tier 3** | Unambiguous ([Sm](/elements/Sm/) is on the Annc 18 list) |
...
| Polishing powder (CeO₂-based) | Ce | **Open** | Unambiguous ([Ce](/elements/Ce/) not on any control list) |
...
| 5. Review | MOFCOM | Internal, no buyer-facing tracking | Statutory 45 working days; HREE applications routinely run 60 to 120+ days actual |
...
| Small-lot | 10 t+ container / contract | 1.0 → 5 to 10× (1 to 10 kg HREE) | LREE small lots: 1.5 to 4× |
| Purity | 3N / 4N standard | 1.0 → 1.5 (5N) | NdFeB feed stays at 3N to 4N |
| Destination | EU | 1.0 EU / 1.3 to 2.0× US / 1.0 to 1.2× JP/KR | Post-Annc 18 destination-selective licensing |

**Empirical gap:** The Chinese-domestic print understates realised small-medium foreign buyer prices by **30 to 80% in steady state, 1.5 to 5× for HREEs or 5N grades, and 5 to 20× for Alibaba sample-sized lots**.

**No public per-kg HREE transaction prices exist** for the seven Announcement-18 controlled REEs to non-Chinese buyers in the April 2025 to May 2026 window. Argus and Fastmarkets publish *assessments* (surveys, not transaction prints); aggregate Chinese customs volumes are visible via CSIS analysis. Any survey of realised HREE prices to Western buyers is therefore generating *original* data, not validating existing data.
...
| Bucket | USD range |
|---|---|
| Origin docs + customs broker + CIQ (China) | $280 to $850 |
| Origin port THC + container stuffing | $380 to $960 |
| **MOFCOM licence + EUC + legal (Tier 3 only)** | **$2,000 to $10,500** |
| US customs broker + ISF + bond | $205 to $585 |
| Destination THC + pier pass + drayage | $585 to $1,175 |

Tier 1 typical fixed: ~$1,500 to $3,500 per shipment.
Tier 3 typical fixed: ~$3,500 to $14,000 per shipment.
...
| Ocean LCL | $60 to $120/CBM |
| Air freight 500 to 1,000 kg | $4 to $7/kg general; +50 to 150% if DG |
| Express courier (samples ≤ 30 kg) | $9 to $18/kg + $80 to $150 minimum |
| Marine cargo insurance | 0.10 to 0.30% of CIF value |

### Axis 3: Value-variable (ad valorem)

See [tariff stack](#us-side-tariff-stack-may-14-2026) above. For REE products in May 2026: MFN 2.1 to 5% + Section 301 25% + MPF (capped $651.50) + HMF 0.125% (sea only). Section 122 zero (Annex II exempt). IEEPA zero (terminated).
...
| L/C tenor (at-sight) | 0.5 to 1.5% per annum + flat $300 to 800 per draft |
| FX hedging if RMB-denominated | ~0.06% for 30-day forward |
| Demurrage at LA / LB after free days | $175 to $600/day depending on tier |
| **Licence processing delay (Tier 3)** | Statutory 45 working days; expect 60 to 120 days actual, dominant cost for samples |
...
| **Dy oxide sample, 1 kg**, Beijing → San Diego, air (Tier 3) | $2,000 | $7,800 to $8,400 | +290 to 320% | MOFCOM licence overhead + tariffs + small-lot premium |
...
Bottom-up fair DDP premium over CIF vs the 8 to 15% industry rule-of-thumb:

| Tier | Bottom-up fair % | Negotiating posture |
|---|---|---|
| 1 (oxide bulk) | ~1.4% | Aggressively negotiate. The 8 to 15% rule is *expensive*. |
...
|---|---|---|
| Academic / R&D, Tier 1 sample (1 to 10 kg) | Alibaba gold-supplier | 1.5 to 2.5× SMM print |
| Academic / R&D, Tier 3 sample (1 to 10 kg) | Western trader **only**, Alibaba is not a legal channel for HREE post-Annc 18 | 3 to 10× SMM print, 60 to 120 day lead |
| Small commercial buyer, Tier 1 (100 kg to 1 t) | Western trader (Tradium, LCM, GE Chaplin) | 1.5 to 2.5× |
| Small commercial buyer, Tier 2 magnet sample | Alibaba gold-supplier magnet shop | 1.2 to 3× |
| Mid-size OEM, Tier 2 magnet container | JL MAG / Yunsheng / Sanhuan / Jintian direct under general licence | ~1.0× Argus REPM |
| Mid-size OEM, Tier 3 magnet container | Japanese trading house or Western trader; Lynas Malaysia DyTb as non-China alternative | 1.5 to 3× plus licence overhead |
...
- **Container-scale or contract.** Markup over producer-direct (20 to 500%) exceeds the convenience benefit.
...
| Beijing Zhongke Sanhuan | 000970.SZ | 30,000 to 35,000 t/yr | Tier 2 GL holder (partial) |
| Ningbo Jintian Copper | 601609.SS | New entrant | Tier 2 GL holder (incl. Ford) |
| Yantai Zhenghai | 300224.SZ | 18,000 to 22,000 t | Standard dual-use licence |
| DMEGC Magnetics | 002056.SZ | 15,000 to 20,000 t (NdFeB) + ferrite | Standard |
...
- The MOFCOM regulatory regime has moved on a 4 to 8 week cadence since April 2025. Any dated claim above is a snapshot; verify before transacting against it. The [regulatory tracker](/regulatory/) catalogues each announcement with primary-source links.
