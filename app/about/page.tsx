...
import { AtomAside } from '@/components/about/AtomAside';
...
export default function AboutPage() {
  ...
  return (
    <Container as="main" className="py-10">
      ...
      {/* Two columns from lg up: the prose sections, and a decorative sticky
      ...
      <div className="lg:grid lg:grid-cols-[minmax(0,1fr)_20rem] lg:gap-16">
        <div>
          ...
          <section className="mt-12 max-w-prose">
            ...
            <div className="space-y-3 text-base leading-relaxed text-fg-muted">
              <p>
                ...
                is an open price reference for rare earth elements and
                strategic metals, built and maintained by an independent
                researcher. Every price is tied to a specific seller, date,
          ...
          <section className="mt-10 max-w-prose">
            ...
            <div className="space-y-3 text-base leading-relaxed text-fg-muted">
              <p>
                ...
                benchmarks sit behind expensive subscriptions, retail prices
                vary by orders of magnitude with form, purity, and quantity,
                and Chinese regulatory developments are poorly tracked in
                English-language sources.
              </p>
              <p>
                Procurement analysts, researchers, and supply chain
                professionals need a single reference point that is open about
                where its numbers come from and what it does not know.
              </p>
            </div>
          </section>
          ...
          <section className="mt-10 max-w-prose">
            ...
            <div className="space-y-3 text-base leading-relaxed text-fg-muted">
              <p>
                Reference prices are assembled from source-cited observations,
                and anyone who has seen a current price can add one. The
                quickest way is the{' '}
