          ...
          <div className="space-y-2">
            {TOPICS.map((t) => {
              ...
              return (
                <label
                  key={t.id}
                  className="flex cursor-pointer items-start gap-2.5 rounded-md border border-border bg-surface px-3 py-2 transition-colors duration-fast hover:border-border-strong"
                >
                  <input
                    type="checkbox"
                    name="topics"
